...
#define GPIO_HIGH(NAME)       ((void) (CONCAT(GPIO, _PORT_FOR_GPIO_WRITE(NAME))->BSRR = CONCAT(_LOCATION_FOR_GPIO_HIGH(NAME), _NUMBER_FOR_GPIO_WRITE(NAME))))
#define GPIO_LOW(NAME)        ((void) (CONCAT(GPIO, _PORT_FOR_GPIO_WRITE(NAME))->BSRR = CONCAT(_LOCATION_FOR_GPIO_LOW(NAME) , _NUMBER_FOR_GPIO_WRITE(NAME))))
