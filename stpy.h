...
#define CMSIS_SET_FROM(VARIABLE, PERIPHERAL, REGISTER, ...)   CMSIS_WRITE(CONCAT(PERIPHERAL##_, REGISTER), (VARIABLE), __VA_ARGS__)
...
//
    ...
    #define USART_BRR_BRR_Pos             0                                             // Missing position and masks.
    ...
    #define SDMMC_IDMABASER_IDMABASER_Pos 0                                             // "
    #define SDMMC_IDMABASER_IDMABASER_Msk (0xFFFFFFFF << SDMMC_IDMABASER_IDMABASER_Pos) // "
    #define SDMMC_IDMACTRL_IDMAEN_Pos     SDMMC_IDMA_IDMAEN_Pos                         // Inconsistent register naming.
    #define SDMMC_IDMACTRL_IDMAEN_Msk     SDMMC_IDMA_IDMAEN_Msk                         // "
    #define SDMMC_IDMACTRL_IDMAEN         SDMMC_IDMA_IDMAEN                             // "
    #define SDMMC_IDMACTRL_IDMABMODE_Pos  SDMMC_IDMA_IDMABMODE_Pos                      // "
    #define SDMMC_IDMACTRL_IDMABMODE_Msk  SDMMC_IDMA_IDMABMODE_Msk                      // "
    #define SDMMC_IDMACTRL_IDMABMODE      SDMMC_IDMA_IDMABMODE                          // "
